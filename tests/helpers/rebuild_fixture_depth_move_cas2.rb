...
FIXTURE_DIR = File.expand_path('../../fixtures/depth-move-cas2', __FILE__)
...
# Cas 2 : e31 déplacé de Liste #3 vers Liste #5 (avec enfant Liste#4, même profondeur)
# Résultat attendu : Liste#4 reste à depth=3 (e31 dans Liste#5 qui est depth=2, donc 2+1=3)
#
#   Liste #3 item_ids : ["e45"]         (e31 retiré)
#   Liste #5 item_ids : ["e88","e31"]   (e31 ajouté)
...
db.close
puts "Fixture depth-move-cas2 rebuilt."

...
FIXTURE_DIR = File.expand_path('../../fixtures/depth-move', __FILE__)
...
# Structure :
#   Liste #1 (projects) → project-a
#   Liste #2 (events, depth=1) → [e14, e23]
#   Liste #3 (events, depth=2) → [e31, e45]   (enfant de e14)
#   Liste #4 (events, depth=3) → [e57, e68]   (enfant de e31)
#   Liste #5 (events, depth=2) → [e88]         (enfant de e23)
...
db.close
puts "Fixture depth-move rebuilt."

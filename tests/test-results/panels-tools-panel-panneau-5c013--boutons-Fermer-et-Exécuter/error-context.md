...
- Name: panels/tools-panel.spec.js >> panneau outils : footer avec faux-boutons Fermer et Exécuter
- Location: specs/e2e/panels/tools-panel.spec.js:58:1
...
Locator: locator('#pane-1').contentFrame().locator('.tools-panel .floating-panel__footer')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.tools-panel .floating-panel__footer')

...
Locator: locator('.floating-panel__item').nth(2).locator('.link-open-popup__key')
Expected: "a"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.floating-panel__item').nth(2).locator('.link-open-popup__key')
...
- main:
  - navigation:
    - button "Séquence 2 de Acte II"
    - text: ‹
  - text: Scène 1 de Séquence 2 de Acte II — Scène 2 de Séquence 2 de Acte II — Scène 3 de Séquence 2 de Acte II. Voir Séquence 3 de Acte I, Scène 1 de Séquence 4 de Acte III et Acte II —
- text: DISP MODE NESTING
- contentinfo "Raccourcis clavier"
- text: AIDE ⇧⌘ ? Séquence 3 de Acte I Dans son évènemencier Sa carte Dans l'autre fenêtre ␛ Fermer ↩︎ Ouvrir
```

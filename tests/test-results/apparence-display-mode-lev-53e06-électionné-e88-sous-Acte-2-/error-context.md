...
- Name: apparence/display-mode-level.spec.js >> LEVEL→NEST : retour dans le lister de l'item sélectionné (e88 sous Acte 2)
- Location: specs/e2e/apparence/display-mode-level.spec.js:121:1

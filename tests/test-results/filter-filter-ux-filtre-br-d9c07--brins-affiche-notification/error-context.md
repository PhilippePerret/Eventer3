...
- Name: filter/filter-ux.spec.js >> filtre brins sans brins disponibles >> Cmd+: puis b sans brins affiche notification
- Location: specs/e2e/filter/filter-ux.spec.js:146:3
...
```yaml
- text: "Intrigue principale IP #d9c8a9 Premier événement — Deuxième événement — DISP MODE NESTING"

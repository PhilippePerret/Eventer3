...
- Name: panels/tools-panel.spec.js >> ⌘+t hors mode LEVEL : ouvre le panneau sans l'outil Consolider
- Location: specs/e2e/panels/tools-panel.spec.js:37:1
...
```yaml
- text: Acte 1 — Acte 2 — DISP MODE NESTING

...
- Name: apparence/style-panel.spec.js >> s ferme le panneau quand il est actif
- Location: specs/e2e/apparence/style-panel.spec.js:39:1
...
Locator:  locator('#pane-1').contentFrame().locator('#style-panel')
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('#style-panel')
    14 × locator resolved to <div id="style-panel" class="style-list">…</div>
       - unexpected value "visible"

```

```yaml
- text: Styles · Événement 1 a Il était une fois une histoire extraordinaire... b Il était une fois une histoire extraordinaire...
```

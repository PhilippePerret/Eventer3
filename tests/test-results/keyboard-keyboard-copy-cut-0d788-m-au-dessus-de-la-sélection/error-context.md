...
- Name: keyboard/keyboard-copy-cut-paste.spec.js >> ⌘+c dans ListerEvent >> ⌘+c + ⌘+v ajoute un item au-dessus de la sélection
- Location: specs/e2e/keyboard/keyboard-copy-cut-paste.spec.js:26:3

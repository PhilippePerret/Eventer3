...
- Name: project/open-existing-project.spec.js >> confirmer l'ouverture : le projet apparaît dans la liste
- Location: specs/e2e/project/open-existing-project.spec.js:43:1
...
- iframe [active] [ref=e3]:
  - generic [ref=f3e1]:
    - generic [ref=f3e5]:
      ...
      - generic [ref=f3e12]:
        - generic [ref=f3e13]: eventer-test-1782968679975
        - generic [ref=f3e15]: roman
      - generic [ref=f3e17]:
        - generic [ref=f3e18]: Projet B
        - generic [ref=f3e20]: roman
      - generic [ref=f3e22]:
        - generic [ref=f3e23]: Projet C
        - generic [ref=f3e25]: roman
      - generic [ref=f3e27]:
        - generic [ref=f3e28]: Projet caché
        - generic [ref=f3e30]: roman
      - generic [ref=f3e32]:
        - generic [ref=f3e33]: eventer-test-1782968679975
        - generic [ref=f3e35]: roman
    - generic:
      - generic: DISP MODE PROJECTS
    - contentinfo "Raccourcis clavier" [ref=f3e36]
    - generic: AIDE ⇧⌘ ?
```

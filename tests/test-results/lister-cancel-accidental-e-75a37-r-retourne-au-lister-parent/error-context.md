...
- Name: lister/cancel-accidental-enter.spec.js >> Annulation entrée accidentelle dans un lister vide >> ← après → accidentel sur event sans sous-lister retourne au lister parent
- Location: specs/e2e/lister/cancel-accidental-enter.spec.js:61:3

...
- Name: texte/constants-panel.spec.js >> ConstantsPanel >> valeur sans constante : ignorée
- Location: specs/e2e/texte/constants-panel.spec.js:142:3
...
Call log:
  - waiting for locator('#pane-1').contentFrame().locator('.constants-row__value').first()

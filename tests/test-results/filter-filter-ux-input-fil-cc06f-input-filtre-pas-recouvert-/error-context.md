...
- Name: filter/filter-ux.spec.js >> input filtre texte ne recouvre pas le contenu >> premier item visible sous l'input filtre (pas recouvert)
- Location: specs/e2e/filter/filter-ux.spec.js:96:3

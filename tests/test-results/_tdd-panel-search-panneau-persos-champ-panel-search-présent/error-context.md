...
- Name: _tdd/panel-search.spec.js >> panneau persos : champ .panel-search présent
- Location: specs/e2e/_tdd/panel-search.spec.js:57:1
...
Locator: locator('#perso-panel .panel-search')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#perso-panel .panel-search')
...
- text: Personnages · Événement 1 ✓ CY Cyrano — — ✓ RO Roxane — —
```

...
- Name: _tdd/perso-panel.spec.js >> créer un perso sans patronyme → badge calculé depuis le titre
- Location: specs/e2e/_tdd/perso-panel.spec.js:284:1
...
Locator:  locator('#pane-1').contentFrame().locator('.perso-item').nth(1).locator('.perso-badge')
Expected: "CO"
Received: "undefinedA"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.perso-item').nth(1).locator('.perso-badge')
    - locator resolved to <span tabindex="0" data-field="badge" class="perso-badge" contenteditable="true">undefinedA</span>
    13 × unexpected value "undefinedA"
       - locator resolved to <span class="perso-badge">undefinedA</span>
    - unexpected value "undefinedA"

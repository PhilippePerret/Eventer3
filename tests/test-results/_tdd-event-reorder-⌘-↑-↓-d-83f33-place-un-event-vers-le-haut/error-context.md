...
- Name: _tdd/event-reorder.spec.js >> ⌘+↑/↓ déplacement events >> ⌘+↑ déplace un event vers le haut
- Location: specs/e2e/_tdd/event-reorder.spec.js:22:3
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.event-item').first()
    14 × locator resolved to <div data-id="e1" tabindex="-1" class="event-item">…</div>

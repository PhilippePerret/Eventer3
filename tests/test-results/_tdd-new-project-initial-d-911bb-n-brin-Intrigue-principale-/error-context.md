...
- Name: _tdd/new-project-initial-data.spec.js >> un nouveau projet sauvegardé a un brin "Intrigue principale"
- Location: specs/e2e/_tdd/new-project-initial-data.spec.js:36:1
  ...
  - generic [ref=f1e1]:
    - main [ref=f1e2]:
      ...
      - generic [active] [ref=f1e7]:
        - generic [ref=f1e8]: eventer-test-1782028787792
        - generic [ref=f1e9]: "---"

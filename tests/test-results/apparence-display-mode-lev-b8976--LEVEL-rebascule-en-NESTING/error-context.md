...
- Name: apparence/display-mode-level.spec.js >> entrer dans un item en mode LEVEL rebascule en NESTING
- Location: specs/e2e/apparence/display-mode-level.spec.js:104:1

...
- Name: _tdd/perso-panel.spec.js >> la coche d'un perso coché sélectionné est blanche (pas verte)
- Location: specs/e2e/_tdd/perso-panel.spec.js:76:1
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.perso-item').first()
    5 × locator resolved to <div data-id="c1" tabindex="-1" class="perso-item selected">…</div>

...
- Name: texte/constants-panel.spec.js >> ConstantsPanel >> constante sans valeur : ignorée
- Location: specs/e2e/texte/constants-panel.spec.js:153:3
...
Call log:
  - waiting for locator('#pane-1').contentFrame().locator('.constants-row__name').first()

...
```yaml
- main: Projet A --- roman eventer-test-1782028797305 --- roman eventer-test-1782028797305 --- roman Projet B --- roman Projet C --- roman Projet caché --- roman
```
...
> 58 |   await expect(pane1(page).locator('#main-panel')).toHaveClass(/event-list/)
  ...
  72 | 
  73 |   await pane1(page).locator('.ftpanel.kpanel').press('Tab')
  74 |   await pane1(page).locator('.ftpanel.kpanel').press('Enter')
  75 |   await expect(pane1(page).locator('.ftpanel.kpanel')).not.toBeVisible()
  76 | 
  ...
  87 |   await expect(pane1(page).locator('.ftpanel.kpanel')).toBeVisible()
  88 |   await pane1(page).locator('.ftpanel.kpanel').press('Enter')

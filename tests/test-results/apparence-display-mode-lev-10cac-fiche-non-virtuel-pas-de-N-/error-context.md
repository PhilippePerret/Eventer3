...
- Name: apparence/display-mode-level.spec.js >> man LEVEL mode : item feuille sans lister enfant s'affiche non-virtuel (pas de '+N')
- Location: specs/e2e/apparence/display-mode-level.spec.js:192:1

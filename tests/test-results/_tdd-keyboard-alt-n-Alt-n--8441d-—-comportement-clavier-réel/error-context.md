...
- Name: _tdd/keyboard-alt-n.spec.js >> Alt+n dans un EventLister >> ⌥n Mac (key='˜') crée un event AU-DESSUS — comportement clavier réel
- Location: specs/e2e/_tdd/keyboard-alt-n.spec.js:68:3
...
Received string:    "Évènement deux—------"
Timeout: 5000ms

...
- Name: project/regression-project-id.spec.js >> créer un brin → persiste après rechargement
- Location: specs/e2e/project/regression-project-id.spec.js:51:1
...
```yaml
- text: "Intrigue principale IP #d9c8a9 AAA #888888 Évènement un — Évènement deux — Évènement trois — DISP MODE NESTING"

...
- Name: _tdd/targets-link.spec.js >> targets persistées : rechargement → cibles toujours présentes
- Location: specs/e2e/_tdd/targets-link.spec.js:106:1
...
Call log:
  ...
  - waiting for locator('.targets-panel')
...
- main:
  - navigation:
    ...
    - text: ‹
  - text: Évènement un —
  - textbox "Titre du nouveau évènement": Évènement deux
  - button "—"
  - button "—"
  - button "—"
  - button "—"
  - text: Évènement trois —

...
- Name: filter/filter-ux.spec.js >> badge FILTRE dans la barre d'état — couleur selon état >> badge FILTRE reste vert si aucun item masqué
- Location: specs/e2e/filter/filter-ux.spec.js:22:3

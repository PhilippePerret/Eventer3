...
- Name: texte/constants-panel.spec.js >> ConstantsPanel >> Shift+Tab depuis le champ valeur revient sur le champ constante (même ligne)
- Location: specs/e2e/texte/constants-panel.spec.js:99:3

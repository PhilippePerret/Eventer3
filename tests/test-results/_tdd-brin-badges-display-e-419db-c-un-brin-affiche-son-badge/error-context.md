...
- Name: _tdd/brin-badges-display.spec.js >> event avec un brin affiche son badge
- Location: specs/e2e/_tdd/brin-badges-display.spec.js:24:1
...
Locator: locator('#pane-1').contentFrame().locator('.event-item').first().locator('.event-brins-badges')
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.event-item').first().locator('.event-brins-badges')

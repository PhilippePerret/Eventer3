...
- Name: perso/perso-no-perso.spec.js >> ouvrir le panneau sans perso existant → 'Votre protagoniste' créé automatiquement
- Location: specs/e2e/perso/perso-no-perso.spec.js:23:1
...
- iframe [active] [ref=e3]:
  - generic [ref=f1e1]:
    - generic [ref=f1e6]:
      - generic [ref=f1e9]:
        - generic [ref=f1e10]: Événement 1
        - generic [ref=f1e12]: —
        - generic [ref=f1e16]: AUT
      - generic [ref=f1e19]:
        - generic [ref=f1e20]: Événement 2
        - generic [ref=f1e22]: —
    - generic:

...
- Name: event/consolidate-level.spec.js >> consolidation : items restent réels après toggle NESTING → LEVEL
- Location: specs/e2e/event/consolidate-level.spec.js:89:1

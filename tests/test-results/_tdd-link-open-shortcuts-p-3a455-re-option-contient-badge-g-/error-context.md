...
- Name: _tdd/link-open-shortcuts.spec.js >> popup : première option contient badge 'g'
- Location: specs/e2e/_tdd/link-open-shortcuts.spec.js:38:1
...
Locator: locator('#pane-1').contentFrame().locator('.floating-panel__item').first().locator('.link-open-popup__key')
Expected: "g"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.floating-panel__item').first().locator('.link-open-popup__key')

...
- Name: project/edit-project.spec.js >> projet avec lister : Tab boucle sur le titre (un seul champ)
- Location: specs/e2e/project/edit-project.spec.js:78:1
...
Locator:  locator('.project-item.selected input[name="title"]')
Expected: focused
Received: inactive
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.project-item.selected input[name="title"]')
    14 × locator resolved to <input type="text" name="title" class="project-item__title" placeholder="Titre du nouveau projet"/>
       - unexpected value "inactive"

```

```yaml
- textbox "Titre du nouveau projet"
```

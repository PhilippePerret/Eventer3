...
- Name: _tdd/keyboard-alt-n.spec.js >> Alt+n dans un EventLister >> Alt+n crée un event AU-DESSUS de l'event sélectionné
- Location: specs/e2e/_tdd/keyboard-alt-n.spec.js:51:3
...
Expected substring: "Évènement un"
Received string:    "—------"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.event-item').nth(1)
    - locator resolved to <div data-id="e2" tabindex="-1" class="event-item">…</div>
    - unexpected value "Évènement deux—------"
    13 × locator resolved to <div data-id="e4" tabindex="-1" class="event-item selected editing">…</div>
       - unexpected value "—------"

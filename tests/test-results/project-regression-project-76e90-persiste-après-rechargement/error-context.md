...
- Name: project/regression-project-id.spec.js >> créer un event imbriqué → persiste après rechargement
- Location: specs/e2e/project/regression-project-id.spec.js:25:1

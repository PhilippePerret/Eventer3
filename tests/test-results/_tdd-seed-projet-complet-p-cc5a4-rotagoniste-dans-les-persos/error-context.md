...
- Name: _tdd/seed-projet-complet.spec.js >> projet seed → "Votre protagoniste" dans les persos
- Location: specs/e2e/_tdd/seed-projet-complet.spec.js:21:1
...
Locator: locator('.perso-item, [data-type="perso"]').first()
...
Call log:
  ...
  - waiting for locator('.perso-item, [data-type="perso"]').first()

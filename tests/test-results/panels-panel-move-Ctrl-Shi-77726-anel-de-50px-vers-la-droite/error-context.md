...
- Name: panels/panel-move.spec.js >> Ctrl+Shift+→ déplace le style panel de 50px vers la droite
- Location: specs/e2e/panels/panel-move.spec.js:40:1
...
```
Error: locator.boundingBox: Test timeout of 15000ms exceeded.
Call log:
  - waiting for locator('#pane-1').contentFrame().locator('.style-panel__inner')
  ...
  - generic [ref=f1e1]:
    - generic [ref=f1e5]:
      - generic [ref=f1e8]:
        ...
        - generic [ref=f1e11]: —
        - generic [ref=f1e15]: AUT
      - generic [ref=f1e18]:
        - generic [ref=f1e19]: Événement 2
        - generic [ref=f1e21]: —
    - generic:
    ...
    - generic: AIDE ⇧⌘ ?
    - generic [ref=f1e24]:
      - generic [ref=f1e26]: Styles · Événement 1
      - generic [ref=f1e27]:
        - generic [active] [ref=f1e28]:
          - generic [ref=f1e30]: a
          - generic [ref=f1e31]: Il était une fois une histoire extraordinaire...
        - generic [ref=f1e32]:
          - generic [ref=f1e34]: b
          - generic [ref=f1e35]: Il était une fois une histoire extraordinaire...
```

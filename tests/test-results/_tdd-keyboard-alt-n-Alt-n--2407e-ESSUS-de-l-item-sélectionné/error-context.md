...
- Name: _tdd/keyboard-alt-n.spec.js >> Alt+n dans la liste des projets >> Alt+n crée un nouvel item AU-DESSUS de l'item sélectionné
- Location: specs/e2e/_tdd/keyboard-alt-n.spec.js:18:3
...
Received string:    "Projet B---roman"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.project-item').nth(1)
    14 × locator resolved to <div tabindex="-1" class="project-item" data-id="00000000-0000-0000-0000-000000000002">…</div>
       - unexpected value "Projet B---roman"

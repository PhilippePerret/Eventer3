...
- Name: _tdd/project-navigation.spec.js >> Projet seed >> projet seed → "Votre protagoniste" dans le panneau persos
- Location: specs/e2e/_tdd/project-navigation.spec.js:188:3
...
```yaml
- text: Acte I Votre protagoniste 🫥 VO Projet modèle Acte I — DISP MODE NESTING

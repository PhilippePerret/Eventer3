...
- Name: _tdd/link-open-shortcuts.spec.js >> popup : 'g' ferme le popup et navigue vers la cible
- Location: specs/e2e/_tdd/link-open-shortcuts.spec.js:62:1
...
Locator: locator('#pane-1').contentFrame().locator('.link-open-popup')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.link-open-popup')

...
- Name: project/edit-project.spec.js >> projet avec lister : seul le titre est éditable
- Location: specs/e2e/project/edit-project.spec.js:65:1
...
Locator:  locator('.project-item.selected input[name="id"]')
...
Call log:
  ...
  - waiting for locator('.project-item.selected input[name="id"]')

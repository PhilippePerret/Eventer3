...
- Name: _tdd/split-pane.spec.js >> Maj+Tab depuis pane 1 → focus dans le pane 2
...
Locator: locator('#split-pane iframe').contentFrame().locator('body')
Expected: focused
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#split-pane iframe').contentFrame().locator('body')

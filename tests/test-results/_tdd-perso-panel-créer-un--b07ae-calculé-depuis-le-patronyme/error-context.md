...
- Name: _tdd/perso-panel.spec.js >> créer un perso avec patronyme → badge calculé depuis le patronyme
- Location: specs/e2e/_tdd/perso-panel.spec.js:272:1
...
Call log:
  - waiting for locator('#pane-1').contentFrame().locator('.perso-item.selected [data-field="patronyme"]')
    - locator resolved to <span tabindex="0" contenteditable="true" data-field="patronyme" class="perso-patronyme"></span>
    - fill("Valjean")
    ...
    - generic [ref=f1e2]:
      ...
      - generic [ref=f1e41]:
        - generic [ref=f1e42]:
          - generic [ref=f1e44]: ✓
          - generic [ref=f1e45]:
            - generic [ref=f1e46]: Cyrano
            - generic [ref=f1e47]:
              - generic [ref=f1e48]: de Bergerac
              - generic [ref=f1e49]: 🫥
              - generic [ref=f1e50]: CY
              - generic [ref=f1e51]: "---"
        - generic [ref=f1e54]:
          - generic [ref=f1e55]: Jean
          - generic [ref=f1e56]:
            - generic [ref=f1e57]: 🫥
            - generic [ref=f1e58]: undefinedA
            - generic [ref=f1e59]: "---"
        - generic [ref=f1e60]:
          - generic [ref=f1e62]: ✓
          - generic [ref=f1e63]:

...
- Name: _tdd/project-navigation.spec.js >> Régression : project_id propagé >> créer un perso → persiste après rechargement
- Location: specs/e2e/_tdd/project-navigation.spec.js:255:3
...
```yaml
- text: Évènement un Votre protagoniste 🫥 VO 🫥 undefinedA Projet A Évènement un — Évènement deux — Évènement trois — DISP MODE NESTING

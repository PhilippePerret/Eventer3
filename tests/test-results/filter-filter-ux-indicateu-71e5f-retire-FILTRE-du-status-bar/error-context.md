...
- Name: filter/filter-ux.spec.js >> indicateur FILTRE dans la barre d'état >> Escape dans l'input efface le filtre et retire FILTRE du status bar
- Location: specs/e2e/filter/filter-ux.spec.js:203:3

...
```ts
  ...
  16 |   await pane1(page).locator('#events-panel').press('b')
...
> 24 |   await titleInput.fill('Brin créé')
  ...
  42 |   await pane1(page).locator('#brins-panel').press('n')

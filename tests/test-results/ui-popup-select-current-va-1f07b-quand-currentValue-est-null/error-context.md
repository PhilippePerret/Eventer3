...
- Name: ui/popup-select-current-value.spec.js >> popup nature projet : option '—' focused quand currentValue est null
- Location: specs/e2e/ui/popup-select-current-value.spec.js:18:1

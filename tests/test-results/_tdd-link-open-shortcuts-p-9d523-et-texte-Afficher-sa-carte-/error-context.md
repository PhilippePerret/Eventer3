...
- Name: _tdd/link-open-shortcuts.spec.js >> popup : deuxième option contient badge 'c' et texte 'Afficher sa carte'
- Location: specs/e2e/_tdd/link-open-shortcuts.spec.js:44:1
...
Locator: locator('#pane-1').contentFrame().locator('.floating-panel__item').nth(1).locator('.link-open-popup__key')
Expected: "c"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.floating-panel__item').nth(1).locator('.link-open-popup__key')

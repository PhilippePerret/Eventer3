...
- Name: filter/filter-ux.spec.js >> indicateur FILTRE dans la barre d'état >> status bar n'affiche plus FILTRE après effacement du filtre
- Location: specs/e2e/filter/filter-ux.spec.js:189:3

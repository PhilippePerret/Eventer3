...
- Name: barre-etat/status-bar-display-mode.spec.js >> barre d'état visible au démarrage avec mode PROJECTS
- Location: specs/e2e/barre-etat/status-bar-display-mode.spec.js:8:1

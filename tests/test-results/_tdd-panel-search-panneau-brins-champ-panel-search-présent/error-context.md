...
- Name: _tdd/panel-search.spec.js >> panneau brins : champ .panel-search présent
- Location: specs/e2e/_tdd/panel-search.spec.js:18:1
...
Locator: locator('#brin-panel .panel-search')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#brin-panel .panel-search')
...
- main:
  - navigation:
    - button "Projet A"
    - text: ‹
  - text: Événement 1 MON CY — Événement 2 —
- text: DISP MODE NESTING
- contentinfo "Raccourcis clavier": "↑ ↓ choisir ⏎ éditer n nouveau après ⌥n nouveau avant ⌘c copier ⌘x couper ⌘v coller avant ⌦ supprimer ← parent → éléments ⌘: filtrer ␣ cocher ⌘⏎ fermer ⌥↓ ⌥↑ Event suivant/précédent"
- text: Brins · Événement 1 ✓
...
- combobox:
  ...
  - option "autre"
- text: ✓
- textbox "Couleur du brin": "#c8d9a9"
- text: AUT Autre brin
- combobox:
  - option "—"
  - option "intrigue principale"

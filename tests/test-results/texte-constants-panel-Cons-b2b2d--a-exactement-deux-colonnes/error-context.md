...
- Name: texte/constants-panel.spec.js >> ConstantsPanel >> le panneau a exactement deux colonnes
- Location: specs/e2e/texte/constants-panel.spec.js:36:3
...
Locator:  locator('#pane-1').contentFrame().locator('.constants-panel__column')
Expected: 2
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.constants-panel__column')

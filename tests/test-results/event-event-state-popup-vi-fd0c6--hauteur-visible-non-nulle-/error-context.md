...
- Name: event/event-state-popup-visible.spec.js >> la liste des options du popup a une hauteur visible (non nulle)
- Location: specs/e2e/event/event-state-popup-visible.spec.js:33:1

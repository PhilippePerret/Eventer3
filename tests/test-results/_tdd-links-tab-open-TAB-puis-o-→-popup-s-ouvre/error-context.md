...
- Name: _tdd/links-tab-open.spec.js >> TAB puis 'o' → popup s'ouvre
- Location: specs/e2e/_tdd/links-tab-open.spec.js:122:1
...
```ts
  ...
  30  |   await expect(pane1(page).locator('.notification')).toContainText(getErr(5210))
  31  | })
  32  | 

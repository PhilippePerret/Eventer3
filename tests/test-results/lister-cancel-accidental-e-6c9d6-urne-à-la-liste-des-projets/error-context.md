...
- Name: lister/cancel-accidental-enter.spec.js >> ← annule la création d'un event dans un lister non-virtuel >> ← pendant la création d'un event retourne à la liste des projets
- Location: specs/e2e/lister/cancel-accidental-enter.spec.js:8:3

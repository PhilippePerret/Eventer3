...
- Name: filter/panel-search.spec.js >> panneau brins : taper 'mon' cache 'Autre brin'
- Location: specs/e2e/filter/panel-search.spec.js:33:1
...
Locator:  locator('#pane-1').contentFrame().locator('.brin-row')
Expected: 2
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.brin-row')
    ...
    - generic [ref=f1e2]:
      - generic [ref=f1e5]:
        - generic [active] [ref=f1e6]:
          - generic [ref=f1e8]: ✓
          - generic [ref=f1e9]:
            - generic [ref=f1e10]: Mon brin
            - generic [ref=f1e11]:
              - generic [ref=f1e12]: MON
      ...
      - generic [ref=f1e25]:
        - generic [ref=f1e28]:
          ...
          - generic [ref=f1e31]: —
          - generic [ref=f1e32]:
            - generic [ref=f1e35]: MON
            - generic [ref=f1e37]:
              - generic [ref=f1e38]: CY
              - generic [ref=f1e39]: RO
        - generic [ref=f1e42]:
          - generic [ref=f1e43]: Événement 2
          - generic [ref=f1e45]: —
    - generic:
      - generic: DISP MODE NESTING
    - contentinfo "Raccourcis clavier" [ref=f1e46]
    - generic: AIDE ⇧⌘ ?
```

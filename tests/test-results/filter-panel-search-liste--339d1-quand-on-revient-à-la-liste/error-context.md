...
- Name: filter/panel-search.spec.js >> liste events : filtre remis à zéro quand on revient à la liste
- Location: specs/e2e/filter/panel-search.spec.js:140:1
...
```yaml
- text: Événement 1 — MON CY RO Événement 2 — DISP MODE NESTING

...
- Name: ui/popup-select-current-value.spec.js >> popup nature évènemencier : option 'défaut' focused quand currentValue est null
- Location: specs/e2e/ui/popup-select-current-value.spec.js:29:1

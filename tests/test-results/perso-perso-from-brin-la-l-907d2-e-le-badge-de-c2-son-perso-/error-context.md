...
- Name: perso/perso-from-brin.spec.js >> la ligne de b1 affiche le badge de c2 (son perso)
- Location: specs/e2e/perso/perso-from-brin.spec.js:96:1
...
Locator: locator('#pane-1').contentFrame().locator('.brin-item').first().locator('.brin-persos-marks .perso-mark')
Expected substring: "RO"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#pane-1').contentFrame().locator('.brin-item').first().locator('.brin-persos-marks .perso-mark')

```

```yaml
- text: "✓ Mon brin MON intrigue #d9c8a9 Événement 1 — MON CY RO Événement 2 — DISP MODE NESTING"

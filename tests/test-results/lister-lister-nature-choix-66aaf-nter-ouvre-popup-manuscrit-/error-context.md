...
- Name: lister/lister-nature.spec.js >> choix 'roman' → champ évènemencier activé par ArrowDown, Enter ouvre popup 'manuscrit'
- Location: specs/e2e/lister/lister-nature.spec.js:102:1

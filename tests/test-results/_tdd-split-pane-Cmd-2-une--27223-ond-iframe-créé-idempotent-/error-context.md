...
- Name: _tdd/split-pane.spec.js >> Cmd+2 une deuxième fois → pas de second iframe créé (idempotent)
- Location: specs/e2e/_tdd/split-pane.spec.js:42:1
...
Locator:  locator('#split-pane iframe')
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#split-pane iframe')

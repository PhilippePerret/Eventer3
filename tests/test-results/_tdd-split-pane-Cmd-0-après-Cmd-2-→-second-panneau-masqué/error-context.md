...
- Name: _tdd/split-pane.spec.js >> Cmd+0 après Cmd+2 → second panneau masqué
- Location: specs/e2e/_tdd/split-pane.spec.js:51:1
...
Call log:
  ...
  - waiting for locator('#split-pane')

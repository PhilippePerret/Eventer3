...
- Name: project/open-existing-project.spec.js >> → sur un projet ouvre la liste de ses events
- Location: specs/e2e/project/open-existing-project.spec.js:58:1
...
```yaml
- text: Projet A roman eventer-test-1782968687026 roman Projet B roman Projet C roman Projet caché roman eventer-test-1782968687026 roman DISP MODE PROJECTS

...
- Name: apparence/display-mode-selection.spec.js >> Bug 2b — LEVEL + ← : navigue vers le lister de l'item sélectionné (pas leaveToParent du lister courant)
- Location: specs/e2e/apparence/display-mode-selection.spec.js:45:1

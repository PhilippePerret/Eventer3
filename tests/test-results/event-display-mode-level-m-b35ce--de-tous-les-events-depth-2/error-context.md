...
- Name: event/display-mode-level.spec.js >> mode LEVEL depth=2 : liste plate de tous les events depth=2
- Location: specs/e2e/event/display-mode-level.spec.js:21:1
...
- generic [active] [ref=e1]:
  - main [ref=e2]:
    - navigation [ref=e3]:
      - button "Acte 1" [ref=e4] [cursor=pointer]
      - generic [ref=e5]: ‹
    - generic [ref=e11]: —
    - generic [ref=e17]: —
  - generic:

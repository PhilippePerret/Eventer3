...
- Name: _tdd/keyboard-alt-n.spec.js >> Alt+n dans la liste des projets >> ⌥n Mac (key='˜') crée un item AU-DESSUS — comportement clavier réel
- Location: specs/e2e/_tdd/keyboard-alt-n.spec.js:34:3
...
Locator: locator('#pane-1').contentFrame().locator('.project-item').first().locator('[data-field="title"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.project-item').first().locator('[data-field="title"]')

...
- Name: filter/filter-ux.spec.js >> badge FILTRE dans la barre d'état — couleur selon état >> badge FILTRE rouge quand items masqués
- Location: specs/e2e/filter/filter-ux.spec.js:33:3

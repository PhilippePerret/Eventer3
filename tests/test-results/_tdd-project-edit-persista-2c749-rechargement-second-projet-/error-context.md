...
- Name: _tdd/project-edit.spec.js >> persistance : le titre modifié survit au rechargement (second projet)
- Location: specs/e2e/_tdd/project-edit.spec.js:118:1
...
Locator:  locator('#pane-1').contentFrame().locator('.project-item').nth(1).locator('.project-title')
Expected: "Titre persistant B"
Received: "Projet B"
Timeout:  5000ms

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('#pane-1').contentFrame().locator('.project-item').nth(1).locator('.project-title')
    14 × locator resolved to <span class="project-title">Projet B</span>
       - unexpected value "Projet B"

...
- Name: apparence/display-mode-level.spec.js >> man lister depth=2 (=man_depth) → LEVEL mode affiche items des listers man (cas normal)
- Location: specs/e2e/apparence/display-mode-level.spec.js:148:1

...
- Name: project/edit-project.spec.js >> projet avec lister : Escape restaure le titre original
- Location: specs/e2e/project/edit-project.spec.js:94:1
...
Locator:  locator('.project-item').first().locator('.project-item__title')
Expected: "Projet A"
Received: ""
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.project-item').first().locator('.project-item__title')

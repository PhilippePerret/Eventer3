...
- Name: event/event-state-popup-visible.spec.js >> le popup d'état affiche des options visibles (pas un popup vide)
- Location: specs/e2e/event/event-state-popup-visible.spec.js:22:1

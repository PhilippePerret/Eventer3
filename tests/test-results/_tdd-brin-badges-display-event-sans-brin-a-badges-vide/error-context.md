...
Locator: locator('#pane-1').contentFrame().locator('.event-item').nth(3).locator('.event-brins-badges')
Expected: empty
Error: element(s) not found

Call log:
  - Expect "toBeEmpty" with timeout 5000ms
  - waiting for locator('#pane-1').contentFrame().locator('.event-item').nth(3).locator('.event-brins-badges')

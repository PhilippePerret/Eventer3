...
- Name: texte/token-replace.spec.js >> Token replacement dans les titres >> badge PPpat remplacé par le patronyme du personnage
- Location: specs/e2e/texte/token-replace.spec.js:31:3
...
Locator: locator('#pane-1').contentFrame().locator('.event-text').nth(2)
Expected: "Philippe Perret arrive à Paris"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('#pane-1').contentFrame().locator('.event-text').nth(2)

...
- Name: _tdd/contextual-help.spec.js >> flèche bas sélectionne le raccourci suivant
- Location: specs/e2e/_tdd/contextual-help.spec.js:87:1
...
Call log:
  - waiting for locator('#pane-1').contentFrame().locator('.contextual-help__row.selected').locator('.contextual-help__key')

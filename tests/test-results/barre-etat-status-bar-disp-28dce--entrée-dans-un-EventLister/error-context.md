...
- Name: barre-etat/status-bar-display-mode.spec.js >> barre d'état passe en NESTING à l'entrée dans un EventLister
- Location: specs/e2e/barre-etat/status-bar-display-mode.spec.js:24:1

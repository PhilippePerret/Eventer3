...
- Name: filter/panel-search.spec.js >> panneau styles : champ .panel-search visible après ':'
- Location: specs/e2e/filter/panel-search.spec.js:88:1
...
Locator: locator('#pane-1').contentFrame().locator('#style-panel .filter-bar')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('#style-panel .filter-bar')
...
- text: AIDE ⇧⌘ ? Styles · Événement 1 a Il était une fois une histoire extraordinaire... b Il était une fois une histoire extraordinaire...
```

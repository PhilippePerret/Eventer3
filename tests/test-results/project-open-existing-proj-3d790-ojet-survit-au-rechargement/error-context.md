...
- Name: project/open-existing-project.spec.js >> persistance : le projet survit au rechargement
- Location: specs/e2e/project/open-existing-project.spec.js:106:1
...
- iframe [active] [ref=e3]:
  - generic [ref=f5e1]:
    - generic [ref=f5e5]:
      - generic [ref=f5e7]:
        - generic [ref=f5e8]: Projet A
        - generic [ref=f5e10]: roman
      - generic [ref=f5e12]:
        - generic [ref=f5e13]: eventer-test-1782968700876
        - generic [ref=f5e15]: roman
      - generic [ref=f5e17]:
        - generic [ref=f5e18]: Projet B
        - generic [ref=f5e20]: roman
      - generic [ref=f5e22]:
        - generic [ref=f5e23]: Projet C
        - generic [ref=f5e25]: roman
      - generic [ref=f5e27]:
        - generic [ref=f5e28]: Projet caché
        - generic [ref=f5e30]: roman
      - generic [ref=f5e32]:
        - generic [ref=f5e33]: eventer-test-1782968700876
        - generic [ref=f5e35]: roman
    - generic:
      - generic: DISP MODE PROJECTS
    - contentinfo "Raccourcis clavier" [ref=f5e36]
    - generic: AIDE ⇧⌘ ?
```

...
- Name: ui/split-close-focused.spec.js >> Alt+0 pane-2 focusé → pane-1 navigue vers l'item sélectionné dans pane-2
- Location: specs/e2e/ui/split-close-focused.spec.js:34:1

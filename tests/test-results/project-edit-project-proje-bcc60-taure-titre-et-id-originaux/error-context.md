...
- Name: project/edit-project.spec.js >> projet sans lister : Escape restaure titre et id originaux
- Location: specs/e2e/project/edit-project.spec.js:187:1
...
Locator:  locator('.project-item').nth(1).locator('.project-item__title')
Expected: "Projet B"
Received: ""
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.project-item').nth(1).locator('.project-item__title')

...
- Name: _tdd/brin-nouveau.spec.js >> en création, l'éditeur de brin a les classes CSS panel-row et brin-row
- Location: specs/e2e/_tdd/brin-nouveau.spec.js:41:1
...
Locator: locator('#pane-1').contentFrame().locator('.brin-item.selected')
Expected pattern: /panel-row/
Received string:  "brin-item selected checked editing"

Call log:
  - Expect "toHaveClass" with timeout 5000ms
  - waiting for locator('#pane-1').contentFrame().locator('.brin-item.selected')
    - locator resolved to <div data-id="b1" tabindex="-1" class="brin-item selected">…</div>
    - unexpected value "brin-item selected"
    4 × locator resolved to <div data-id="b2" tabindex="-1" class="brin-item selected checked editing">…</div>
      - unexpected value "brin-item selected checked editing"

```

```yaml
- text: "✓ Autre brin #888888 AUT brin"
```

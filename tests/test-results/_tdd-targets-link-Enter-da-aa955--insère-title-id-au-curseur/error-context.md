...
- Name: _tdd/targets-link.spec.js >> Enter dans TargetsPanel → insère [title](id) au curseur
- Location: specs/e2e/_tdd/targets-link.spec.js:57:1
...
- main:
  - navigation:
    ...
    - text: ‹
  - text: Évènement un —
  - textbox "Titre du nouveau évènement": avant
  - button "—"
  - button "—"
  - button "—"
  - button "—"

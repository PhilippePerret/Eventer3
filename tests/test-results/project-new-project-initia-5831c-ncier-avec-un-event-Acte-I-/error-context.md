...
- Name: project/new-project-initial-data.spec.js >> un nouveau projet sauvegardé a un évènemencier avec un event "Acte I"
- Location: specs/e2e/project/new-project-initial-data.spec.js:22:1
...
- generic [active] [ref=e1]:
  - main [ref=e2]:
    ...
    - generic [ref=e6]:
      - generic [ref=e7]: eventer-test-1781242842690
      - generic [ref=e8]: d0d51d92-84d1-4339-892a-c379ad1a24d9

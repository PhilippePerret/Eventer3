...
- Name: lister/lister-nature.spec.js >> panneau nature → footer a boutons 'Annuler' et 'Appliquer' alternables par Tab
- Location: specs/e2e/lister/lister-nature.spec.js:79:1
...
Locator: locator('#pane-1').contentFrame().locator('.nature-panel .floating-panel__footer')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.nature-panel .floating-panel__footer')

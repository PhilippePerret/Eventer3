...
- Name: _tdd/perso-panel.spec.js >> éditer un perso et vider le badge → recalculé depuis le patronyme
- Location: specs/e2e/_tdd/perso-panel.spec.js:305:1
...
Call log:
  ...
  - waiting for locator('#pane-1').contentFrame().locator('.perso-item').first().locator('.perso-badge')
    14 × locator resolved to <span class="perso-badge">CY</span>
       - unexpected value "CY"

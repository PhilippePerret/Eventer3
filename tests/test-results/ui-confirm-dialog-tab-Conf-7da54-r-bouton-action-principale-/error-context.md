...
- Name: ui/confirm-dialog-tab.spec.js >> ConfirmDialog : bouton 'Oui' focused par défaut (dernier bouton = action principale)
- Location: specs/e2e/ui/confirm-dialog-tab.spec.js:32:1

export default class StatusBar {
  ...
  static update(listerType) {
    ...
    if (!el) return
    const text = listerType === 'Project'
      ? 'DISP MODE PROJECTS'
      : `DISP MODE ${StatusBar._displayMode}`
    let badge = ''
  ...
  static get displayMode() { return StatusBar._displayMode }
  static resetToNesting()  { StatusBar._displayMode = 'NESTING' }
}

...
- [x] « p » ouvre le panneau des personnages s’il n’est pas actif
- [x] « p » ferme le panneau des personnages s’il n’est pas actif
...
- [x] « b » ouvre le panneau des brins s’il n’est pas actif
- [x] « b » ferme le panneau des brins si c’est le panneau actif
- [x] Le panneau des brins ne devrait jamais être vide. <= Un projet devrait TOUJOURS avoir au moins un brin « modèle ».

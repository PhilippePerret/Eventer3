...
> - **Architecture-brief ≠ cible** : `doc/BIBLE/_architecture-brief.md` décrit l'ancienne architecture et peut contredire ce document — c'est ce document qui fait foi.
